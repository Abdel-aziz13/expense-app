...
const Utilisateurs = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/admin/utilisateur`)
      .then((res) => {
        setData(res.data.utilisateur);
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-4xl mx-auto py-12 px-4 space-y-6 sm:px-6 lg:px-8">
